...
export const locationSuggestions = [
    'Anandapuri', 'Hooghly', 'Rajarhat Chowmatha', 'Chingrighata', 'Purbachal Kalitala',
    ...
    'Patuli', 'Hazra', 'Action Area 2B', 'Action Area 2 New Town', 'Narayantala', 'Action Area 3',
    'Jogendra Garden', 'Panditiya Road', 'Bally', 'Chandannagar', 'Deshapriya Park', 'Camac Street',
    ...
    'New Town Action Area 3', 'Ballygunge Circular Road', 'Jheel Bagan', 'Narendrapur', 'Action Area 1',
    ...
    'Rajarhat Chowmatha', 'Sunny Park', 'Uttarpara Kotrung', 'Naipukur', 'Hanapara',
    ...
    'Jodhpur Park', 'New Town Action Area 1D', 'Baghajatin Place', 'Keyatala', 'Jyangra', 'Kamalgazi',
    ...
    'Azadgarh', 'Ruby Hosp Main Road', 'New Barrackpore', 'Budherhat', 'Tiljala', 'Usha Park',
    ...
    'Dashadrone', 'East Topsia', 'Kabardanga', 'New Town Action Area 2D', 'Maheshtala',
    ...
    'Lake Town/Kalindi', 'Madhyamgram Digberia', 'Ajc Bose Road', 'Tetultala', 'Deshapriya Park',
